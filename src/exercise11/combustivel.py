...
class bombaCombustível:
    ...
    def abastecerPorValor(self, valor): # método onde é informado o valor a ser abastecido e mostra a quantidade de litros que foi colocada no veículo
        ...
        return print(f"A quantidade de litros que foi colocada no veículo foi: {int(litros)} litros do tipo {self.tipoCombustivel}")

    def abastecerPorLitro(self, litro): # método onde é informado a quantidade em litros de combustível e mostra o valor a ser pago pelo cliente. 
    ...
    def alterarCombustivel(self, valor, tipo): # altera o tipo do combustível
        ...
        return print(f"O valor agora é: {self.alterarValor} e o combustivel agora é: {self.tipoCombustivel}")

    def alterarQuantidadeCombustivel(self, litros): # altera a quantidade de combustível restante na bomba
        self.quantidadeCombustivel = (self.quantidadeCombustivel - litros)
        return print(f"Quantidade de combustivel restante: {self.quantidadeCombustivel}")
